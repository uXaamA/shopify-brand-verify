        ...
        "orders": [
            {
                ...
                "qr_hash":        o.qr_hash,
                "verify_url":     f"https://overventurously-nondenunciating-kody.ngrok-free.dev/verify/{o.qr_hash}",
...
async def get_qr_image(
    ...
    verify_url = f"https://overventurously-nondenunciating-kody.ngrok-free.dev/verify/{order.qr_hash}"
